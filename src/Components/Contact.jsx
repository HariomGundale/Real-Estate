...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "da1e61f2-16ff-4b61-a0ce-613644c9d802");
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
            <div className='flex flex-wrap'>
                <div className='w-full md:w-1/2 text-left'>
                    Name:
                    <input className='w-full border border-gray-300 rounded py-3 py-4 mt-2' type="text" name='Name' placeholder='   Your Name' required/>
                </div>
                <div className='w-full md:w-1/2 text-left md:pl-4'>
                    Email:
                    <input className='w-full border border-gray-300 rounded py-3 py-4 mt-2' type="email" name='Email' placeholder='   Your Email' required/>
                </div>
            </div>
